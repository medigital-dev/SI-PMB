...
<div class="col-lg-8 mx-auto p-4 py-md-5 bg-body shadow-lg">
  <main class="px-lg-5">
    ...
    <div class="row">
      ...
      <div class="row row-cols-md-3 row-cols-lg-4 row-cols-1 row-cols-sm-2 d-flex gx-4 justify-content-center">
  ...
  <footer class="pt-5 my-5 px-5 text-body-secondary border-top d-flex flex-column flex-lg-row justify-content-between align-items-center text-center text-lg-start">
    ...
    <a href="https://github.com/medigital-dev/PPDB_SMP-2-Wonosari" target="_blank" class="text-muted text-center text-lg-end text-decoration-none small"><i class="bi bi-github me-1"></i>v2.2.00_Beta</a>
  </footer>
</div>
